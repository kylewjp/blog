...
//					$content .= "<a href='".MAIN_SITE_URL.DS."index.php?act=advclick&op=advclick&adv_id=".$adv_id."&ap_class=".$ap_class."' target='_blank'><img src='".$pic."' width='".$width."' height='".$height."' /></a>";
			}
			$content .= "</div>\");";	 
		 }
		}
...
//					$content .= "document.write(\"<a href='".MAIN_SITE_URL.DS."index.php?act=advclick&op=advclick&adv_id=".$adv_id."&ap_class=".$ap_class."' target='_blank'>";
