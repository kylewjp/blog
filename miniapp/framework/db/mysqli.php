...
class Db{
	...
	public static function query($sql, $host = 'master'){
		...
		if ($query === false){
            ...
            logOut($sql." [ RunTime:".addUpTime('queryStartTime','queryEndTime',6)."s ]"."\r\n",'sql');
			return $query;
		}
	}
	 ...
	 */	
	public static function getAll($sql, $host = 'master'){
		self::connect($host);
     ...
     * @return array
     */
	public static function select($param, $obj_page='', $host = 'master'){
		self::connect($host);
		static $_cache = array();
	 ...
	 * @return int
	 */
	public static function getCount($table, $condition = null, $host = 'master'){
		self::connect($host);
	 ...
	 * @return array
	 */
	public static function showTables($host = 'master'){
		self::connect($host);
		$sql = 'SHOW TABLES';
		$result = self::query($sql,$host);
		$array = array();
	 ...
	 * @return string
	 */
	public static function showCreateTable($table, $host = 'master'){
		self::connect($host);
	 ...
	 * @return array
	 */
	public static function showColumns($table, $host = 'master'){
		self::connect($host);
