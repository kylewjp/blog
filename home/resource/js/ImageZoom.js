...
(function(global, document, $, undefined){
	...
	ImageZoom.prototype = {
		...
		buildDOM: function(){
			...
			this.controllers = shell.find('.control a');
		...
		initEvent: function(){
			...
			this.shell.delegate('.control a', 'mouseenter', function(){
				if(self.level < 3){
					var trigger = this;
					clearTimeout(timer);
			...
			.delegate('.control a', 'mouseleave', function(){
				clearTimeout(timer);
			})
			.delegate('.control a', 'click', function(e){
				e.preventDefault();
	...
	ImageZoom.defaultOptions = {
		tmpl: '<div class="gallery_wrap">{gallery}</div><div class="controller_wrap"><div class="control">{controllers}</div><a href="javascript:;" class="prev"><span>&#171;</span></a><a href="javascript:;" class="next"><span>&#187;</span></a></div><div class="close_wrap">{closeButton}</div>',
		items: [],
		shell: null,
		basePath: 'images/',
		levelASize: [60, 60],
