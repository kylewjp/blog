      ...
      <div class="server">
        <table width="100%">
		  ...
		  <tr>
            ...
            <td><div id="J_install_tip_dbhost"><span class="gray">数据库服务器地址，一般为localhost/127.0.0.1</span></div></td>
          </tr>
		  <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="tpblog" class="input" onBlur="TestDbPwd(0)"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="jq_" class="input" ></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个自助安装时需修改</span></div></td>
          </tr>
          <tr>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="自助安装" class="input"></td>
          ...
          <tr>
            ...
            <td><input type="text" name="sitekeywords" value="自助安装,b2c商城系统，thinkphp" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">商城描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="自助安装的开发旨在帮助创业者搭建企业网站平台，实现创业梦想。"></td>
...
<!--            <td><input type="text" name="manager" id="manager" value="admin" class="input" readonly></td>-->
<!--            <td><div id="J_install_tip_manager"></div></td>-->
<!--          </tr>-->
<!--            <tr>-->
<!--                <td class="tar">管理员密码：</td>-->
<!--                <td>-->
<!--                    <input type="text" name="manager_pwd" id="manager_pwd" value="123456"  class="input"  readonly>-->
<!--                    <input type="hidden" name="manager_ckpwd" id="manager_ckpwd"  class="input" value="123456" >-->
<!--                </td>-->
