 ...
 * session
 */
require_once(BASE_DATA_PATH.DS.'api'.DS.'snsapi'.DS.'qqzone'.DS.'comm'.DS."session.php");
...
$_SESSION['qqzone']["callback"] = MAIN_SITE_URL."/index.php?act=member_sharemanage&op=share_qqzone";
//QQ授权api接口.按需调用
