...
class article_classModel{
	...
	private function _condition($condition){
        ...
        if ($condition['ac_id_and_children'] != ''){
            $condition_str .= " and (ac_parent_id = '". intval($condition['ac_id_and_children']) ."' or ac_id = '".intval($condition['ac_id_and_children'])."')";
        }
