...
class mb_homeModel extends Model{
     ...
     * @return array
	 */
	public function getMbHomeList($condition, $page = null, $order = 'h_type asc, h_sort asc', $field = '*') {
    ...
    public function add($param){
        ...
        $result = Db::insert('mb_home',$param);
        return $result;
    }
    /**
     * 删除
    ...
    public function del($id){
        if (intval($id) > 0){
            $where = " h_id = '". intval($id) ."'";
            $result = Db::delete('mb_home',$where);
            return $result;
        }else {
            return false;
        }
