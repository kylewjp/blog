...
class articleControl extends SystemControl{
	...
	public function __construct(){
        ...
        $this->type = $_SESSION['article_type'];
	}
	/**
	 * 文章管理
	 */
	public function articleOp(){
		 ...
		 * 检索条件
		 */
        if(!empty($_GET['search_ac_id']) || $_GET['search_ac_id']==0 ){
            $condition['ac_id_childs'] = intval($_GET['search_ac_id']);
        }
        ...
        Tpl::output('article_type',$this->type);
