...
<div class="login-layout">
  <div class="top">
    <h5>
        <?php if (empty($output['list_setting']['site_name'])){?>
            <?php echo $lang['login_index_title_01'];?>
        <?php }else{ ?>
            <?php echo $output['list_setting']['site_name'];?>
        <?php } ?>
        <em></em>
    </h5>
  ...
  <div class="box">
    <form method="post" id="form_login">
      ...
      <input type="hidden" name="SiteUrl" id="SiteUrl" value="<?php echo MAIN_SITE_URL;?>" />
      <span>
...
<div class="bottom">
  <h5>
      <?php if (empty($output['list_setting']['site_name'])){?>
          <?php echo $lang['common_info_shopnc'];?>
      <?php }else{ ?>
          <?php echo $output['list_setting']['site_name'];?>
      <?php } ?>© Copyright 2017
  </h5>
  <h6 title="<?php echo $lang['common_info_shopnc'];?>">
       Powered by © Company
      【<a href="#" target="_blank"><?php echo $output['list_setting']['icp_number'];?></a>】
  </h6>
</div>
