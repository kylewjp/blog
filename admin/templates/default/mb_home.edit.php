...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=mb_home&op=mb_home_add" ><span><?php echo $lang['nc_add'];?></span></a></li>
  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" ><label for="h_url">类型:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
		  <select name="h_type">
              <option value="显示" <?php if($output['home_array']['h_type']=='显示'){ ?>selected <?php } ?>>显示</option>
              <option value="隐藏" <?php if($output['home_array']['h_type']=='隐藏'){ ?>selected <?php } ?>>隐藏</option>
		  </select>
		  </td>
...
<!--                  <img class="show_image" src="--><?php //echo ADMIN_TEMPLATES_URL;?><!--/images/preview.png">-->
                <img width="25px" height="25px" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MOBILE.'/home/'.$output['home_array']['h_img'];?>">
            <div class="type-file-preview">
                <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MOBILE.'/home/'.$output['home_array']['h_img'];?>">
            </div>
        ...
        <tr class="noborder">
          <td colspan="2" ><label for="h_url">链接地址:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['home_array']['h_url'];?>" name="h_url" id="h_url" class="txt"></td>
          <td class="vatop tips">链接地址，带http://</td>
        </tr>
