...
<!--            <td class="align-center"><a href="index.php?act=article_class&op=article_class_edit&ac_id=--><?php //echo $v['ac_id'];?><!--">--><?php //echo '删除';?><!--</a>-->
            <td class="align-center">
                <a href="index.php?act=article_class&op=article_class_edit&ac_id=<?php echo $v['ac_id'];?>"><?php echo $lang['nc_edit'];?></a>&nbsp;|
<!--                <a href="index.php?act=article_class&op=article_class_del&ac_id=--><?php //echo $v['ac_id'];?><!--">--><?php //echo $lang['nc_del'];?><!--</a>-->
            <?php if($v['ac_code'] == ''){?>
