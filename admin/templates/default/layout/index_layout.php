    ...
    <tr>
		...
		<p>
            <?php if (empty($output['list_setting']['site_name'])){?>
                <?php echo $lang['common_info_reserved_right'];?>
            <?php }else{ ?>
                版权所有：<?php echo $output['list_setting']['site_name'];?>
            <?php } ?>
		</p>
		</div>
		</td>
      <td valign="top" width="100%">
		  <iframe src="" id="workspace" name="workspace" style="overflow: visible;" frameborder="0" width="100%" height="100%" scrolling="yes" onload="window.parent">
		  </iframe>
	  </td>
    </tr>
  </tbody>
