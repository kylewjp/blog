...
<!--        </tr>-->
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="1" name="h_sort" id="h_sort" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="h_url" id="h_url" class="txt"></td>
