      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
              <?php if(empty($output['article_type']) || $output['article_type']==0 ){ ?>
              ...
              <?php }else{ ?>
                  ...
                  <select name="ac_id" id="ac_id">
                      <?php if(!empty($output['parent_list']) && is_array($output['parent_list'])){ ?>
                          <?php foreach($output['parent_list'] as $k => $v){ ?>
                              <?php if ($v['ac_id']==$output['article_type'] || $output['article_type'] ==$v['ac_parent_id'] ){ ?>
                                  <option <?php if($output['article_array']['ac_id'] == $v['ac_id']){ ?>selected='selected'<?php } ?> value="<?php echo $v['ac_id'];?>"><?php echo $v['ac_name'];?></option>
                              <?php } ?>
                          <?php } ?>
                      <?php } ?>
...
<!--                  --><?php //foreach($output['parent_list'] as $k => $v){ ?>
<!--                      --><?php //if($output['article_type'] == $v['ac_id']){ echo $v['ac_name']; } ?>
<!--                  --><?php //} ?>
<!--                  <input type="hidden" value="--><?php //echo $output['article_type'];?><!--" name="ac_id" id="ac_id" class="txt">-->
              <?php } ?>
