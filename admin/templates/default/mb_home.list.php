...
<!--          <th>多关键词</th>-->
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td><input type="checkbox" name='del_id[]' value="<?php echo $v['h_id']; ?>" class="checkitem"></td>
...
<!--          <td>--><?php //echo $v['h_multi_keyword'];?><!--</td>-->
          <td class="picture"><?php 
				if($v['h_img'] != ''){
					echo "<div class='size-64x32'><span class='thumb size-364x32'><i></i><img width=\"64\" height=\"32\" src='".$v['h_img_url']."' /></span></div>";
				}
				?></td>
        ...
        <?php if(!empty($output['h_list']) && is_array($output['h_list'])){ ?>
            <tr class="tfoot">
                ...
                <td colspan="16">
                    ...
                    <a href="JavaScript:void(0);" class="btn" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_link').submit();}">
